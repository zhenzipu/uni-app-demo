...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'15b179da'])
Z([3,'_view 15b179da center'])
Z([3,'handleProxy'])
Z([3,'_view 15b179da logo'])
Z([[7],[3,'$k']])
Z([1,'15b179da-0'])
Z([[2,'?:'],[[2,'!'],[[7],[3,'login']]],[1,'logo-hover'],[1,'']])
Z([3,'_image 15b179da logo-img'])
Z([[2,'?:'],[[7],[3,'login']],[[6],[[7],[3,'uerInfo']],[3,'avatarUrl']],[[7],[3,'avatarUrl']]])
Z([3,'_view 15b179da logo-title'])
Z([3,'_text 15b179da uer-name'])
Z([a,[3,'Hi，'],[[2,'?:'],[[7],[3,'login']],[[6],[[7],[3,'uerInfo']],[3,'name']],[1,'您未登录']]])
Z([[2,'!'],[[7],[3,'login']]])
Z([3,'_text 15b179da go-login navigat-arrow'])
Z([3,''])
Z([3,'_view 15b179da center-list'])
Z([3,'_view 15b179da center-list-item border-bottom'])
Z([3,'_text 15b179da list-icon'])
Z([3,''])
Z([3,'_text 15b179da list-text'])
Z([3,'收藏商品'])
Z([3,'_text 15b179da navigat-arrow'])
Z(z[14])
Z([3,'_view 15b179da center-list-item'])
Z(z[17])
Z([3,''])
Z(z[19])
Z([3,'关注商品'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'6b57211a'])
Z([3,'_view 6b57211a container'])
Z([3,'_view 6b57211a page-body'])
Z([3,'_scroll-view 6b57211a nav-left'])
...
Z(z[5])
Z([3,'handleProxy'])
Z([a,[3,'_view 6b57211a nav-left-item '],[[2,'?:'],[[2,'=='],[[7],[3,'index']],[[7],[3,'categoryActive']]],[1,'active'],[1,'']]])
Z([[7],[3,'$k']])
Z([[2,'+'],[1,'6b57211a-0-'],[[7],[3,'index']]])
Z([[7],[3,'index']])
Z([a,[[6],[[7],[3,'item']],[3,'NAME']]])
Z(z[9])
Z([3,'_scroll-view 6b57211a nav-right'])
Z(z[11])
Z([1,'6b57211a-1'])
Z([[7],[3,'scrollTop']])
Z([a,z[4][1],z[4][2]])
...
Z(z[5])
Z([3,'_view 6b57211a nav-right-item'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'7fe00116'])
Z([3,'_view 7fe00116 page'])
Z([3,'_view 7fe00116'])
Z([3,'handleProxy'])
Z([3,'_scroll-view 7fe00116 scroll-view_H'])
Z([[7],[3,'$k']])
Z([1,'7fe00116-0'])
Z([3,'120'])
Z([3,'true'])
Z([3,'_view 7fe00116 scroll-view-item_H uni-bg-red'])
Z([3,'demo1'])
Z([3,'A'])
Z([3,'_view 7fe00116 scroll-view-item_H uni-bg-green'])
Z([3,'demo2'])
Z([3,'B'])
Z([3,'_view 7fe00116 scroll-view-item_H uni-bg-blue'])
Z([3,'demo3'])
Z([3,'C'])
Z([3,'_view 7fe00116 uni-product-list'])
Z([3,'index'])
Z([3,'product'])
Z([[7],[3,'productList']])
Z(z[19])
Z([3,'_view 7fe00116 uni-product'])
Z([[7],[3,'index']])
Z([3,'_view 7fe00116 image-view'])
Z([[7],[3,'renderImage']])
Z([3,'_image 7fe00116 uni-product-image'])
Z([[6],[[7],[3,'product']],[3,'image']])
Z([3,'_view 7fe00116 uni-product-title'])
Z([a,[[6],[[7],[3,'product']],[3,'title']]])
Z([3,'_view 7fe00116 uni-product-price'])
Z([3,'_text 7fe00116 uni-product-price-favour'])
Z([a,[3,'￥'],[[6],[[7],[3,'product']],[3,'originalPrice']]])
Z([3,'_text 7fe00116 uni-product-price-original'])
Z([a,z[33][1],[[6],[[7],[3,'product']],[3,'favourPrice']]])
Z([3,'_text 7fe00116 uni-product-tip'])
...
var oB=_n('view')
_rz(z,oB,'class',1,e,s,gg)
cs.push("./pages/classify/classify.vue.wxml:view:1:66")
var xC=_n('view')
...
var fE=_v()
_(oD,fE)
cs.push("./pages/classify/classify.vue.wxml:view:1:205")
...
cs.pop()
_(xC,oD)
cs.push("./pages/classify/classify.vue.wxml:scroll-view:1:505")
...
var eN=_v()
_(tM,eN)
cs.push("./pages/classify/classify.vue.wxml:view:1:733")
var bO=function(xQ,oP,oR,gg){
cs.push("./pages/classify/classify.vue.wxml:view:1:733")
var cT=_mz(z,'view',['class',25,'id',1,'key',2],[],xQ,oP,gg)
cs.push("./pages/classify/classify.vue.wxml:image:1:907")
var hU=_mz(z,'image',['class',28,'src',1],[],xQ,oP,gg)
cs.pop()
_(cT,hU)
cs.push("./pages/classify/classify.vue.wxml:view:1:966")
var oV=_n('view')
...
var oB=_n('view')
_rz(z,oB,'class',1,e,s,gg)
cs.push("./pages/new/new.vue.wxml:view:1:61")
var xC=_n('view')
_rz(z,xC,'class',2,e,s,gg)
cs.push("./pages/new/new.vue.wxml:scroll-view:1:90")
var oD=_mz(z,'scroll-view',['bindscroll',3,'class',1,'data-comkey',2,'data-eventid',3,'scrollLeft',4,'scrollX',5],[],e,s,gg)
cs.push("./pages/new/new.vue.wxml:view:1:259")
var fE=_mz(z,'view',['class',9,'id',1],[],e,s,gg)
var cF=_oz(z,11,e,s,gg)
_(fE,cF)
cs.pop()
_(oD,fE)
cs.push("./pages/new/new.vue.wxml:view:1:337")
var hG=_mz(z,'view',['class',12,'id',1],[],e,s,gg)
var oH=_oz(z,14,e,s,gg)
_(hG,oH)
cs.pop()
_(oD,hG)
cs.push("./pages/new/new.vue.wxml:view:1:417")
...
cs.pop()
_(oB,xC)
cs.push("./pages/new/new.vue.wxml:view:1:517")
var lK=_n('view')
...
cs.push("./pages/new/new.vue.wxml:view:1:563")
var oR=_mz(z,'view',['class',23,'key',1],[],bO,eN,gg)
cs.push("./pages/new/new.vue.wxml:view:1:703")
var fS=_n('view')
_rz(z,fS,'class',25,bO,eN,gg)
var cT=_v()
_(fS,cT)
if(_oz(z,26,bO,eN,gg)){cT.wxVkey=1
cs.push("./pages/new/new.vue.wxml:image:1:743")
cs.push("./pages/new/new.vue.wxml:image:1:743")
var hU=_mz(z,'image',['class',27,'src',1],[],bO,eN,gg)
cs.pop()
_(cT,hU)
cs.pop()
}
...
cs.pop()
_(oR,fS)
cs.push("./pages/new/new.vue.wxml:view:1:855")
var oV=_n('view')
...
cs.pop()
_(oR,oV)
cs.push("./pages/new/new.vue.wxml:view:1:926")
var oX=_n('view')
_rz(z,oX,'class',31,bO,eN,gg)
cs.push("./pages/new/new.vue.wxml:text:1:973")
var lY=_n('text')
...
cs.pop()
_(oX,lY)
cs.push("./pages/new/new.vue.wxml:text:1:1062")
var t1=_n('text')
...
cs.pop()
_(oX,t1)
cs.push("./pages/new/new.vue.wxml:text:1:1151")
var b3=_n('text')
_rz(z,b3,'class',36,bO,eN,gg)
var o4=_oz(z,37,bO,eN,gg)
_(b3,o4)
cs.pop()
_(oX,b3)
cs.pop()
...
aL.wxXCkey=2
_2z(z,21,tM,e,s,gg,aL,'product','index','index')
cs.pop()
cs.pop()
_(oB,lK)
cs.pop()
